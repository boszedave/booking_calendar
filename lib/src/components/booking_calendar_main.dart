                  ...
                  CommonCard(
                    child: TableCalendar(
                      availableCalendarFormats: widget.availableCalendarFormats ??
                          const {CalendarFormat.month: 'Month', CalendarFormat.twoWeeks: '2 weeks', CalendarFormat.week: 'Week'},
                      ...
                      Wrap(
                        ...
                        children: [
                          ...
                          if (widget.hideBreakTime != null && widget.hideBreakTime == false)
                            BookingExplanation(color: widget.pauseSlotColor ?? Colors.grey, text: widget.pauseSlotText ?? "Break"),
                        ],
                      ),
                  const SizedBox(height: 8),
